# Extracted from https://github.com/LuminosoInsight/langcodes/blob/master/langcodes/data/language-subtag-registry.txt
LANGUAGES = [
    {'code':'aa', 'name':'Afar'},
    ...
    {'code':'ee', 'name':'Ewe'},
    {'code':'el', 'name':'Greek, Modern Greek'},
    ...
    {'code':'gn', 'name':'Guarani, Guaraní'},
    {'code':'gu', 'name':'Gujarati'},
    {'code':'gv', 'name':'Manx'},
    {'code':'ha', 'name':'Hausa'},
    {'code':'he', 'name':'Hebrew, Modern Hebrew'},
    {'code':'hi', 'name':'Hindi'},
    ...
    {'code':'sk', 'name':'Slovak'},
    {'code':'sl', 'name':'Slovenian, Slovene'},
    {'code':'sm', 'name':'Samoan'},
    {'code':'sn', 'name':'Shona'},
    {'code':'so', 'name':'Somali'},
