...
kw_extractor = yake.KeywordExtractor(n=[1,2,3],top=100, stoplen=2, windowsSize=1, WG=False, ReDup=False)
...
# stopword 후보 기록
# ['허','말','보내','원인','명시','자체','조금','보이','진지','가지','거기','안녕하세요','지정','유용','하','업','누구','누구','음','낫','표시','하','하','궁','어느','보이','그녀','충','누구','쉬','바라',
# '두','어떤','여러','고려','모르','적절','왜','서술','동안','한','따르','불구','셋째','최소한','당','통하','믿','밑','전적','대부분','현재','제외','작','뭐','어디','주위','두','최','반면','정해진',
# '너머','하','누','그','물론','따르','당신','떨어지','근래','가지','상응','인','코스','하','끝','포','미','비의','알','누구','그것','감사','필요','자','생각','절대','끝나','재','한편','어떻','다음',
# '사용','위','원인','얻','공동','근처','보살피','을','이것','어디','정도','그녀','하','맞','짧','예전','사라지','뒤','아마','분별','금후','어디','불행','지나','이다','고','제','바라','소','유지',
# '하','그렇','알','오','되','보','적','건너','어느','경유','에다','허용','즉각','존재','그','그렇','우리','모든','잡','늙','우리들의','있','찍','것','이내','향하','지금','아래','알리','당신','그',
# '말','후보','괴롭','밖','전반','전처','환영','넘','알','무슨','너','나야','그','가','그것','소설','모두','그것','나타나','원하','하','그렇','받','스루','심각','그','여부','얻','네','최근','오',
# '이용','위하','나','가능','되','후자','대하','앞','유지','우','알','상대','내면','의','부탁','간다','오','어디','중','겉보기','안','전','아물','철저','들','보이','특별','사이','놓','그리','그런',
# '이','어떻','오호','일어나','보이','가','거기','있','다음','둘','리','저','그렇','지','합리','몇','나아가','무시','여러','여기','분','맘','사용','나','전부','고맙습니다','아무도','이것','누구',
# '지금','하','다른','연관','타','그것','되','보','까','말','보','더하','신규','그녀','대신','안쪽','그','둘째','어디']
